          ...
          <div class="col-lg-8">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Registrasi</h1><p>Aplikasi Pengaduan Masyarakat</p>
              </div>
                ...
                <form class="user" method="post" action="cek_login.php">
                  ...
                  <form class="user" method="post" action="cek_login.php">
                    <div class="form-group">
                      <input type="text" name="telp" class="form-control form-control-user"  placeholder="Masukan Nomor Telepon...">
                    </div>
