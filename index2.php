              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome Admin/Petugas</h1> <p>Aplikasi Pengaduan Masyarakat</p>
                  </div>
                  <form class="user" method="post" action="check_login2.php">
                 ...
                 <hr>
                  <div class="text-center">
                    <a class="small" href="index.php">Masuk sebagai User</a>
                  </div>
                </div>
              </div>
            </div>
